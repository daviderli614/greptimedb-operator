...
func (in *BackendStorage) DeepCopyInto(out *BackendStorage) {
	*out = *in
	if in.EtcdStorage != nil {
		in, out := &in.EtcdStorage, &out.EtcdStorage
		*out = new(EtcdStorage)
		(*in).DeepCopyInto(*out)
	}
	if in.MySQLStorage != nil {
		in, out := &in.MySQLStorage, &out.MySQLStorage
		*out = new(MySQLStorage)
		**out = **in
	}
	if in.PostgreSQLStorage != nil {
		in, out := &in.PostgreSQLStorage, &out.PostgreSQLStorage
		*out = new(PostgreSQLStorage)
		**out = **in
	}
}
...
func (in *DatanodeSpec) DeepCopyInto(out *DatanodeSpec) {
	*out = *in
	...
	if in.StartNodeID != nil {
		in, out := &in.StartNodeID, &out.StartNodeID
		*out = new(int32)
		**out = **in
	}
}
...
func (in *FrontendSpec) DeepCopyInto(out *FrontendSpec) {
	*out = *in
	...
	if in.EnableObjectStorage != nil {
		in, out := &in.EnableObjectStorage, &out.EnableObjectStorage
		*out = new(bool)
		**out = **in
	}
	if in.AuditLog != nil {
...
func (in *GreptimeDBClusterSpec) DeepCopyInto(out *GreptimeDBClusterSpec) {
	*out = *in
	...
	if in.DatanodeGroups != nil {
		in, out := &in.DatanodeGroups, &out.DatanodeGroups
		*out = make([]*DatanodeSpec, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(DatanodeSpec)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KafkaSASLSecretRef) DeepCopyInto(out *KafkaSASLSecretRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KafkaSASLSecretRef.
func (in *KafkaSASLSecretRef) DeepCopy() *KafkaSASLSecretRef {
	if in == nil {
		return nil
	}
	out := new(KafkaSASLSecretRef)
...
func (in *MetaSpec) DeepCopyInto(out *MetaSpec) {
	*out = *in
	in.ComponentSpec.DeepCopyInto(&out.ComponentSpec)
	if in.BackendStorage != nil {
		in, out := &in.BackendStorage, &out.BackendStorage
		*out = new(BackendStorage)
		(*in).DeepCopyInto(*out)
	}
